...
function Hero() {
  ...
  return (
    <div className="flex flex-row justify-center bg-[#1995AD] items-center font-bold font-delius-regular overflow-y-scroll h-[80vh] box-border">
      ...
      >
        <h1 className="text-5xl text-[#1995AD] edu-nsw-act-hand-pre-700 font-bolder m-8 mt-12 justify-center flex">Let’s Get You Airborne</h1>
