...
function Hero() {
  ...
  return (
    <div className="flex flex-row pb-[5%] justify-center bg-[#1995AD] items-center font-bold font-delius-regular overflow-y-scroll h-[93vh] box-border">
      ...
      >
        ...
        <h1 className="text-2xl font-bold ">Our intuitive tool lets you select your eVTOL configuration and input key design parameters to instantly generate sizing calculations, performance estimates, and design insights—streamlining your concept development process.
          </h1>
                    <p className="justify-right p-6 px-10 font-black text-8xl">Select Your Configuration   ➜ </p>
      </motion.div>
